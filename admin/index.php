...
<div class="border">
  <div class="avatar">
    ...
    <a style="font-size: 14px;">Logged in as <a href="https://localhost/profiles.php?username=<?php echo $username; ?>" style="color: <?php echo $color; ?>;"><?php echo $username; ?></a></a>
  <br>

        <div class="social-media">
<hr>

<a href="login.php" style="color:white; background-color: transparent; border: none; text-decoration: none;">
    <button style="color:white; background-color: transparent; border: none;">
...
<?php
if ($hasperms == 1) {
    echo '<a href="geninvs.php" style="color: white; background-color: transparent; border: none; text-decoration: none; display: flex; justify-content: center; align-items: center; width: 100%;">';
    echo '<button style="color: white; background-color: transparent; border: none; display: block; margin: -15px auto 0; text-align: center;">';
    echo '<h1 style="font-size: 15px;">invites</h1>';
    echo '</button>';
    echo '</a>';
} else {
    echo '';
