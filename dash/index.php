...
<br>
  ...
  <a href="editprofile.php" style="color:white; background-color: transparent; border: none; text-decoration: none;">
    <button style="color:white; background-color: transparent; border: none;">
    <h1 style="font-size: 15px;">edit profile</h1>
    </button>
  </a>
  ...
  <?php
if ($hasperms == 1) {
    echo '<a href="../admin/index.php" style="color: white; background-color: transparent; border: none; text-decoration: none;">';
    echo '<button style="color: white; background-color: transparent; border: none;">';
    echo '<h1 style="font-size: 15px;">admin panel</h1>';
    echo '</button>';
    echo '</a>';
} else {
    echo '';
