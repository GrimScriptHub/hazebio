...
<form method="POST">
        <br>
        <input type="text" style="color: white; background-color: transparent; border: none; margin-top: 10px;" name="username" id="username" placeholder="Username" data-val="true" data-val-required="The Login field is required." value=""><br>
        <input type="password" style="color: white; background-color: transparent; border: none; margin-top: 10px;" name="password" id="password" placeholder="Password" data-val="true" data-val-required="The Password field is required."><br><br>

        <input type="hidden" name="submit_login" id="submit_login" value="submit_login">

        <button data-sitekey="6LfwzG4iAAAAAI8zFD6H7IwbDB8ov6_PRB_qDFvQ" data-callback="onSubmit" data-action='submit' name="submit_login" style="color: white; background-color: transparent; border: none; margin-top: 10px;" style="margin-top: 10px">Login</button>
        <br>
